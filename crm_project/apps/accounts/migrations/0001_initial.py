    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('manager', 'Manager'), ('team_leader', 'Team Leader'), ('executive', 'Executive'), ('managing_director', 'Managing Director'), ('backend_team', 'Backend Team')], default='executive', max_length=20)),
